<?php get_header();
/**
 * Template Name: Portfolio Style One Template
 */
?>
<?php
...
if( $w_studio_query->have_posts() ) : ?>
    <section>
        ...
        <input type="hidden" name="fileName" value="template-portfolio-style-1">
        <!-- Main content start -->
        <div class="wl-main-content">
            <div id="template-portfolio-style-1" <?php post_class(); ?>>
                ...
                <div class="container wl-row4">
                    ...
                    <div class="row">
                        <div id="js-grid-col-one" class="cbp cbp-l-grid-mosaic wl-cbp-no-padding wl-one-col">
                            <?php
