...
add_action( 'tgmpa_register', 'w_studio_register_required_plugins' );
 ...
 */
function w_studio_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'               => esc_html__('WPBakery Visual Composer', 'w-studio'), // The plugin name.
		...
		// This is an example of how to include a plugin bundled with a theme.
		array(
			'name'               => esc_html__('W Studio Plugin', 'w-studio'), // The plugin name.
			'slug'               => 'w-studio-plugin', // The plugin slug (typically the folder name).
			'source'             => get_template_directory() . '/plugins/w-studio-plugin.zip', // The plugin source.
		...
		array(
			'name'      => esc_html__('Redux Framework', 'w-studio'),
			'slug'      => 'redux-framework',
			'required'  => true,
		),
		array(
			'name'      => esc_html__('Contact Form 7', 'w-studio'),
			'slug'      => 'contact-form-7',
			'required'  => false,
		),
	 ...
	 */
	$config = array(
		'id'           => 'w_studio',                 // Unique ID for hashing notices for multiple instances of TGMPA.
