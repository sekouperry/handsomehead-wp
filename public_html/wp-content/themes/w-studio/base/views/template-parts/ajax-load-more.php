...
class Load_more {
    ...
    public $w_studio_hover_style;

    public $w_studio_limit;

    public function __construct( $w_studio_template_name , $w_studio_start_point , $w_studio_limit , $w_studio_hover_style ) {
        $this->w_studio_template_name = $w_studio_template_name;
        $this->w_studio_start_point = $w_studio_start_point * $w_studio_limit;
        $this->w_studio_hover_style = $w_studio_hover_style;
    ...
    public function load_content() {
        ...
        $w_studio_hoverStyle = 'hover-effect-' . $this->hover_style;
        if( $this->hover_style == 3 ) {
            $w_studio_hoverParentClass = 'hover-parent-' . $this->hover_style;
            $w_studio_imageStyle = 'hover-img-' . $this->hover_style;
        }
        if( $this->hover_style == 4 ) {
            $w_studio_hoverBorderClass = 'icon-border';
        }
        if( $this->hover_style == 7 ) {
        ...
        if( $w_studio_query->have_posts() ) {
            ...
            <?php if( $this->w_studio_template_name == 'portfolio-col-1' ) {
                $w_studio_counter = $this->start_point;
                $w_studio_class = '';
                $w_studio_hoverStyle = '';
                if( $this->hover_style == 2 ) {
                    $w_studio_hoverStyle = 'hover-effect-2';
                } else {
                ...
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    ...
                    echo esc_attr( $w_studio_counter ); ?>">
                        <div class="<?php echo esc_attr( $w_studio_class ); ?>  wl-relative row">
                ...
                endwhile; ?>
            <?php
            } else if( $this->w_studio_template_name == 'portfolio-col-2' ) {
                ...
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    ...
                    <div class="cbp-item <?php echo esc_attr( $w_studio_terms ); ?>">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 wl-paddingzero wl-sibling-hover-2">
                                <div
                ...
                <?php
                endwhile;
            } else if( $this->w_studio_template_name == 'portfolio-col-3' ) {
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    $w_studio_category = get_the_terms( $post->ID , 'portfolio-category' );
                    $w_studio_terms = '';
                    for( $w_studio_count = 0 ; $w_studio_count < count( $w_studio_category ) ; $w_studio_count++ ) {
                    ...
                    <div class="cbp-item <?php echo esc_attr( $w_studio_terms ); ?>">
                        <div
                            ...
                            <?php if( $this->hover_style == 5 || $w_studio_hover_style == 7 || $w_studio_hover_style == 9 ) { ?>
                                <div class="<?php echo esc_attr( $w_studio_imageStyle ); ?>">
                                    <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'w_studio_image_300x225' ); ?></a>
                                </div>
                            <?php } else { ?>
                                <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'w_studio_image_300x225' ); ?></a>
                            ...
                            if( $w_studio_hover_style != 7 ) { ?>
                                <div class="<?php echo esc_attr( $w_studio_hoverStyle ); ?>">
                                    ...
                                    <?php } else { ?>
                                        <div class="hover-inner">
                                            <?php if( $w_studio_hover_style == 5 ) { ?>
                                                <h5 class="wl-color1 top-zero"><?php the_title(); ?></h5>
                                                <span class="wl-color1">
                                                    <?php get_template_part( 'base/views/template-parts/portfolio-category' ); ?>
                                                </span>
                                            <?php } else if( $w_studio_hover_style == 6 ) { ?>
                                                <div class="wl-inner-rotate">
                                                    <a href="<?php the_permalink(); ?>" class="wl-color1 pull-right"
                                                       data-icon=&#x30;></a>
                                            ...
                                            <?php } else if( $w_studio_hover_style == 9 ) { ?>
                                                <div class="hover-text">
                                                    <h5 class="wl-color1 top-zero"><?php the_title(); ?></h5>
                                                        <span class="wl-color1">
                                                            <?php get_template_part( 'base/views/template-parts/portfolio-category' ); ?>
                ...
                <?php
                endwhile;
            } else if( $this->w_studio_template_name == 'portfolio-masonry-1' ) {
                $w_studio_counter = 0;
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                        ...
                        <div class="cbp-caption">
                            ...
                            <div class="cbp-caption-activeWrap hover-effect-1">
                                ...
                                <div class="hover-text">
                                    ...
                                    <span class="wl-color1"><?php the_category( ', ' ); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                <?php endwhile;
            } else if( $this->w_studio_template_name == 'portfolio-masonry-2' ) {
                $w_studio_counter = 0;
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    $w_studio_image_width = '';
                    $w_studio_image_height = '';
                ...
                <?php endwhile;
            } else if( $this->w_studio_template_name == 'portfolio-masonry-3' ) {
                $w_studio_counter = 0;
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    $w_studio_image_width = '';
                    $w_studio_image_height = '';
                ...
                <?php endwhile;
            } else if( $this->w_studio_template_name == 'portfolio-style-1' ) {
                $w_studio_counter = $this->start_point - 1;
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    $w_studio_category = get_the_terms( $post->ID , 'portfolio-category' );
                    $w_studio_terms = '';
                    for( $w_studio_count = 0 ; $w_studio_count <= count( $w_studio_category ) ; $w_studio_count++ ) {
                    ...
                    ?>
                    <div class="cbp-item <?php echo esc_attr( $w_studio_terms ); ?>">
                        <div class="column-2 clearfix row">
                            <div
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12 wl-sibling-hover-2">
                                <div
                                    ...
                                    <?php if( $this->hover_style == 5 || $this->hover_style == 7 || $this->hover_style == 9 ) { ?>
                                        <div class="<?php echo esc_attr( $w_studio_imageStyle ); ?>">
                                    ...
                                    if( $this->hover_style != 7 ) { ?>
                                        <div class="<?php echo esc_attr( $w_studio_hoverStyle ); ?>">
                                            ...
                                            <?php } else { ?>
                                                <div class="hover-inner">
                                                    <?php if( $this->hover_style == 5 ) { ?>
                                                        <h5 class="wl-color1 top-zero"><?php the_title(); ?></h5>
                                                        <span class="wl-color1">
                                                    <?php get_template_part( 'base/views/template-parts/portfolio-category' ); ?>
                                                </span>
                                                    <?php } else if( $this->hover_style == 6 ) { ?>
                                                        <div class="wl-inner-rotate">
                                                            <a href="<?php the_permalink(); ?>"
                                                               class="wl-color1 pull-right" data-icon=&#x30;></a>
                                                    ...
                                                    <?php } else if( $this->hover_style == 9 ) { ?>
                                                        <div class="hover-text">
                                                            <h5 class="wl-color1 top-zero"><?php the_title(); ?></h5>
                                                        <span class="wl-color1">
                                                            <?php get_template_part( 'base/views/template-parts/portfolio-category' ); ?>
                    ...
                    $w_studio_counter++;
                endwhile;
            } else if( $this->w_studio_template_name == 'portfolio-style-2' ) {
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    $w_studio_category = get_the_terms( $post->ID , 'portfolio-category' );
                    $w_studio_terms = '';
                    for( $w_studio_count = 0 ; $w_studio_count < count( $w_studio_category ) ; $w_studio_count++ ) {
                    ...
                    <div class="cbp-item <?php echo esc_attr( $w_studio_terms ); ?>">
                        <div class="clearfix column-2 row">
                ...
                <?php
                endwhile;
            } else if( $this->w_studio_template_name == 'portfolio-style-3' ) {
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    $w_studio_category = get_the_terms( $post->ID , 'portfolio-category' );
                    $w_studio_terms = '';
                    for( $w_studio_count = 0 ; $w_studio_count <= count( $w_studio_category ) ; $w_studio_count++ ) {
                    ...
                    <div class="cbp-item <?php echo esc_attr( $w_studio_terms ); ?>">
                        <div class="clearfix blog-sidebar-col-2 row">
                ...
                <?php
                endwhile;
            } else if( $this->w_studio_template_name == 'portfolio-style-4' ) {
                while( $w_studio_query->have_posts() ) : $w_studio_query->the_post();
                    $w_studio_category = get_the_terms( $post->ID , 'portfolio-category' );
                    $w_studio_terms = '';
                    for( $w_studio_count = 0 ; $w_studio_count <= count( $w_studio_category ) ; $w_studio_count++ ) {
