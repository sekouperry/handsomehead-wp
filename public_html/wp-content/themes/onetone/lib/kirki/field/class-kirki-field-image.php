...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'onetone' ),
				'change'       => esc_attr__( 'Change image', 'onetone' ),
				'default'      => esc_attr__( 'Default', 'onetone' ),
				'remove'       => esc_attr__( 'Remove', 'onetone' ),
				'placeholder'  => esc_attr__( 'No image selected', 'onetone' ),
				'frame_title'  => esc_attr__( 'Select image', 'onetone' ),
				'frame_button' => esc_attr__( 'Choose image', 'onetone' ),
			)
		);
	}
