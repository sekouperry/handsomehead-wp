...
class TwitterOAuth
{
    ...
    {
        $w_studio_counts = strpos($header, ':');
        if (!empty($w_studio_counts)) {
            $key = str_replace('-', '_', strtolower(substr($header, 0, $w_studio_counts)));
            $value = trim(substr($header, $w_studio_counts + 2));
