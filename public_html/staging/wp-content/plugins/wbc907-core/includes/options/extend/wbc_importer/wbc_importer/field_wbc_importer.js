...
(function($) {
    ...
    $.redux.wbc_importer = function() {
        $('body').on('click', '.wbc-builder-button',function(){
            if($(this).hasClass('active')){
                $(this).removeClass('active');
                $('body').find('.wbc_importer .theme').show();
            }else{
                $('.wbc-builder-button').removeClass('active');
                $(this).addClass('active');
                if( $(this).hasClass('elementor-builder')){
                    $('body').find('.wbc_importer .theme').has('.wbc-builder-wpbakery').hide();
                    $('body').find('.wbc_importer .theme').has('.wbc-builder-elementor').show();
                }else{
                    $('body').find('.wbc_importer .theme').has('.wbc-builder-wpbakery').show();
                    $('body').find('.wbc_importer .theme').has('.wbc-builder-elementor').hide();
                }
            }
        });
