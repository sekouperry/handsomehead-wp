...
(function( $ ) {
            ...
            function() {
                ...
                el.each(
                    function() {
                        ...
                        //init when value is changed
                        $( this ).find(
                            '.redux-typography-margin-top,.redux-typography-margin-bottom, .redux-typography-size, .redux-typography-height, .redux-typography-word, .redux-typography-letter, .redux-typography-align, .redux-typography-transform, .redux-typography-font-variant, .redux-typography-decoration'
                        ).keyup(
                            function() {
    ...
    redux.field_objects.typography.margin_top = function( obj ) {
        var margin_top = 0,
            key;
    ...
    redux.field_objects.typography.margin_bottom = function( obj ) {
        var margin_bottom = 0,
            key;
